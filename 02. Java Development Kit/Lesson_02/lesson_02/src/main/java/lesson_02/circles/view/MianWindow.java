...
import lesson_02.circles.exceptions.BallsOverflowException;
import lesson_02.circles.sprites.Background;
import lesson_02.circles.sprites.Ball;
...
public class MianWindow extends JFrame implements CanvasRepaintListener, Thread.UncaughtExceptionHandler {
    ...
    public void iconCircles() {
        // изменение стандартной иконки java в игровом окне
        try {
            ImageIcon imageIcon = new ImageIcon("src/images/circle.png");
