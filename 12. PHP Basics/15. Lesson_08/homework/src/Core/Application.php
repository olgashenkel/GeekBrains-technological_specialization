...
class Application {
    ...
    // Объявляем свойство логгера (стр. 8 методички)
    ...
    public function __construct() {
        ...
        // Настраиваем логирование в файл log/debug.log (стр. 7-8 методички)
        self::$logger = new Logger('application_logger');
        self::$logger->pushHandler(
            new StreamHandler(__DIR__ . '/../../log/debug.log', Level::Debug)
        );
    }
